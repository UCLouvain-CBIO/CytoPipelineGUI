# License
    ...
    CytoPipelineGUI Licensing
    ============================================

    This file attempts to include all licenses that apply within CytoPipelineGUI (this program) source tree, in particular any that are supposed to be exposed to the end user for credit requirements for instance.
    ...
    *************************************************************************
    ...
    It can be found here:  https://github.com/UCLouvain-CBIO/CytoPipelineGUI
